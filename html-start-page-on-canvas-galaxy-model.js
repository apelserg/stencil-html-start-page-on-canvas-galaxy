...
APELSERG.MODEL.MakeContent = function () {
    ...
    switch (contentSelector) {
        ...
        case 7:
            ...
            break;
        case 8:
            content.push(new APELSERG.MODEL.ContentLine("Надейся", pointX, pointY + addY * Cnt++, color));
            content.push(new APELSERG.MODEL.ContentLine("Пока ещё не закончился твой обратный отсчёт", pointX, pointY + addY * Cnt++, color));
            break;
        case 0:
        default:
